...
module.exports = function(list, options, out, onDone) {
  ...
  */
  ...
  list.packages.forEach(function(packageObj, current) {
    ...
    // store remapped for all packages
    total += Object.keys(remapped).length;
    Object.keys(remapped).forEach(function(key) {
      tasks.push(function(done) {
        out.write(JSON.stringify(key) + ': '+ 'function(module, exports, require) { module.exports = ' + remapped[key] + ' }');
        eol();
        done();
      });
    });
