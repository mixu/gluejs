...
module.exports = function(opts, onDone) {
  ...
  renamed.forEach(function(pair) {
    ...
    // filter out any files which use the canonical file name,
    // change any files that are rename results to
    // use the canonical file name

    files = files.filter(function(file) {
      var hasCanonicalFilename = (file.filename == canonical);
