...
API.prototype.render = function(out) {
  ...
  var invalidationOpts = 'amd' + opts['gluejs-version']; //new Date().getTime() + 'amd' + opts['gluejs-version'];

  // console.log(invalidationOpts);
  ...
  runner.once('done', function(err, files) {
    ...
    // console.log(require('util').inspect(files, null, 20, true));
    // console.log(require('util').inspect(err, null, 20, true));
